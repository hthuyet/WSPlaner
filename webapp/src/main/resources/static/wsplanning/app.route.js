            ...
            resolve: {
                ...
                listField: function ($http, $q, $translate) {
                    var listField = [
                        ...
                        {Id: "TransactionType", Name: $translate.instant('TransactionType'), order: false,  length:16, format:'string'},
                        ...
                        {Id: "EstimatedTimeTot", Name: $translate.instant('EstimatedTimeTot'), order: false,  length:2, format:'dd.mm.yyyy'},
                        ...
                        {Id: "ServiceAdvisorId", Name: $translate.instant('ServiceAdvisorId'), order: false, length:10, format:'string'},
                        {Id: "ServiceDate", Name: $translate.instant('ServiceDate'), order: false, length:0, format:'dd.mm.yyyy'},
                        {Id: "SubContractorInfo", Name: $translate.instant('SubContractorInfo'), order: false, length:16, format:'string'},
                        {Id: "Mileage", Name: $translate.instant('Mileage'), order: false, length:10, format:'string'},
                        ...
                        {Id: "CheckOutDate", Name: $translate.instant('CheckOutDate'), order: false, length:16,format:'dd.mm.yyyy'},
                        {Id: "DeliveredBy", Name: $translate.instant('DeliveredBy'), order: false, length:16,format:'string'},
                        ...
                        {Id: "Make", Name: $translate.instant('Make'), order: false, length:16,format:'string'},
                        {Id: "Model", Name: $translate.instant('Model'), order: false, length:16,format:'string'},
                        {Id: "SubModel", Name: $translate.instant('SubModel'), order: false, length:16,format:'string'},
