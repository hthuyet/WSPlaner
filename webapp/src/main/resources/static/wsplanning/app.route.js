        ...
        .state('app.main.gridWO', {
            ...
            resolve: {
                ...
                listField: function ($http, $q, $translate) {
                    var listField = [
                        {Id: "WorkOrderStatus", Name: $translate.instant('WorkOrderStatus'), order: false, length:16, format:'string'},
                        {Id: "SubStatus", Name: $translate.instant('SubStatus'), order: false,  length:16,format:'string'},
                        {Id: "VisitReasonCode", Name: $translate.instant('VisitReasonCode'), order: false,  length:16, format:'string'},
                        {Id: "DeptId", Name: $translate.instant('DeptId'), order: false,  length:16, format:'string'},
                        {Id: "TransactionType", Name: $translate.instant('TransactionType'), order: false,  length:2, format:'string'},
                        {Id: "WorkOrderNo", Name: $translate.instant('WorkOrderNo'), order: false, length:10, format:'string'},
                        {Id: "PayerInfo", Name: $translate.instant('PayerInfo'), order: false, length:30, format:'string'},
                        {Id: "EstimatedTimeTot", Name: $translate.instant('EstimatedTimeTot'), order: false,  length:16, format:'dd.mm.yyyy'},
                        {Id: "PoolTimeTot", Name: $translate.instant('PoolTimeTot'), order: false,  length:16, format:'dd.mm.yyyy'},
                        {Id: "BookedTimeTot", Name: $translate.instant('BookedTimeTot'), order: false, length:16, format:'dd.mm.yyyy'},
                        {Id: "ServiceAdvisorId", Name: $translate.instant('ServiceAdvisorId'), order: false, length:16, format:'string'},
                        {Id: "ServiceDate", Name: $translate.instant('ServiceDate'), order: false, length:16, format:'dd.mm.yyyy'},
                        {Id: "SubContractorInfo", Name: $translate.instant('SubContractorInfo'), order: false, length:30, format:'string'},
                        {Id: "Mileage", Name: $translate.instant('Mileage'), order: false, length:10, format:'number'},
                        {Id: "Reference", Name: $translate.instant('Reference'), order: false, length:16,format:'string'},
                        {Id: "WorkOrderNote", Name: $translate.instant('WorkOrderNote'), order: false, length:16,format:'string'},
                        {Id: "CheckOutDate", Name: $translate.instant('CheckOutDate'), order: false, length:16,format:'dd.MM.yyyy hh:mm'},
                        {Id: "DeliveredBy", Name: $translate.instant('DeliveredBy'), order: false, length:10,format:'string'},
                        {Id: "WorkReadyDate", Name: $translate.instant('WorkReadyDate'), order: false, length:16,format:'dd.mm.yyyy'},
                        {Id: "WorkReadyBy", Name: $translate.instant('WorkReadyBy'), order: false, length:16,format:'string'},
                        {Id: "AttachmentFilesCount", Name: $translate.instant('AttachmentFilesCount'), order: false, length:16,format:'string'},
                        {Id: "LicenseNo", Name: $translate.instant('LicenseNo'), order: false, length:20,format:'string'},
                        {Id: "SearchKey", Name: $translate.instant('SearchKey'), order: false, length:20,format:'string'},
                        {Id: "VIN", Name: $translate.instant('VIN'), order: false,  length:17,format:'string'},
                        {Id: "FirstRegDate", Name: $translate.instant('FirstRegDate'), order: false, length:16,format:'dd.mm.yyyy'},
                        {Id: "NextServiceDate", Name: $translate.instant('NextServiceDate'), order: false, length:16,format:'dd.mm.yyyy'},
                        {Id: "NextMOTDate", Name: $translate.instant('NextMOTDate'), order: false, length:16,format:'dd.mm.yyyy'},
                        {Id: "PreviousServiceDate", Name: $translate.instant('PreviousServiceDate'), order: false, length:16,format:'dd.mm.yyyy'},
                        {Id: "Make", Name: $translate.instant('Make'), order: false, length:20,format:'string'},
                        {Id: "Model", Name: $translate.instant('Model'), order: false, length:20,format:'string'},
                        {Id: "SubModel", Name: $translate.instant('SubModel'), order: false, length:20,format:'string'},
                        {Id: "CustNo", Name: $translate.instant('CustNo'), order: false, length:10,format:'string'},
                        {Id: "Fname", Name: $translate.instant('Fname'), order: false, length:20,format:'string'},
                        {Id: "Lname", Name: $translate.instant('Lname'), order: false, length:20,format:'string'},
                        {Id: "ContactFName", Name: $translate.instant('ContactFName'), order: false, length:20,format:'string'},
                        {Id: "ContactLName", Name: $translate.instant('ContactLName'), order: false, length:20,format:'string'},
                        {Id: "CourtesyCarInfo", Name: $translate.instant('CourtesyCarInfo'), order: false, length:20,format:'string'},
                        {Id: "VehicleNote", Name: $translate.instant('VehicleNote'), order: false, length:40,format:'string'},
                        {Id: "WorkReadyForInvoiceDate", Name: $translate.instant('WorkReadyForInvoiceDate'), order: false, length:20,format:'dd.MM.yyyy hh:mm'},
