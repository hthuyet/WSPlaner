            ...
            resolve: {
                ...
                listField: function ($http, $q, $translate) {
                    var listField = [
                        ...
                        // {Id: "VisitReason", Name: $translate.instant('VisitReasonGrid'), order: false,  length:16, format:'string', type:'string'},
                        {Id: "DeptId", Name: $translate.instant('DeptId'), order: false,  length:16, format:'string', type:'string'},
                        // {Id: "Derpartment", Name: $translate.instant('Derpartment'), order: false,  length:16, format:'string', type:'string'},
