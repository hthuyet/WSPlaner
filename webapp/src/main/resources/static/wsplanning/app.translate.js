...
var translationsDE = {
    ...
    LicenseNo: "Fz-Ident.Nr",
    VIN: "VIN",
    Model: "Modell",
    StampingCode: "Stempel Codes",
    NA: "N/V",
    No: "Nr.",
    CodeName: "Code - Name",
    Code: "Code",
    Job_No: "Job Nr.",
    EstimatedTime: "Plandauer",
    Complaint: "Beanstandung",
    Diagnotisc: "Diagnose",
    Solution: "Lösung",
    ChargeCategory: "Kostenkategorie",
    Template_1: "Vorlage 1",
    Template_2: "Vorlage 2",
    Reset: "Zurücksetzen",
    TakeScreenshot: "Bildschirmaufnahme",
    DoYouSave: "Änderungen speichern? ",
    //Mitteilung
    recentNotification: "Aktuelle Mitteilung",
    unreadNotification: "Ungelesene Mitteilung",
    btnReply: "Antwort",
    timestamp: "Timestamp",
    from: "Von",
    workOrder: "Auftrag",
    ...
    taskWO: "Auftrag",
    taskBody: "Aufgabe",
    taskSeries: "Task Serie",
    taskStarted2: "Begonnen",
    markDone: "Erledigt markieren",
    markSeriesDone: "Serie erledigt markieren",
    green: "Grün",
    red: "Rot",
    orange: "Orange",
    clear: "Löschen",
...
var translationsFR = {
    ...
    VIN: "VIN",
    Model: "Modèle",
    StampingCode: "Codes timbrage",
    NA: "D/P",
    No: "N°",
    CodeName: "Code - Nom",
    Code: "Code",
    Job_No: "N° Job",
    EstimatedTime: "Durée prévue",
    Complaint: "Réclamation",
    Diagnotisc: "Diagnotique",
    Solution: "Solution",
    ChargeCategory: "Catégorie de frais",
    Template_1: "Modèle 1",
    Template_2: "Modèle 2",
    Reset: "Remise à zéro",
    ...
    //Liste de tâches
    taskList: "Liste de tâches",
    taskOpen: "Tâche ouverte",
    taskClose: "Tâche fermer",
    taskStarted: "Obéir à",
    taskHeader: "Sujet",
    taskType: "Type",
    taskCustomer: "Client",
    taskPhone: "Tél.",
    taskEmail: "E-Mail",
    taskWO: "Ordre de travaile",
    taskBody: "Content",
    taskSeries: "Série de tâches",
    taskStarted2: "Commencé",
    markDone: "Marque terminé",
    markSeriesDone: "Marque série terminé",
    green: "Vert",
    red: "Rouge",
    orange: "Orange",
    clear: "Effacer",
...
var translationsIT = {
    ...
    VIN: "VIN",
    Model: "Modello",
    StampingCode: "Codici timbrature",
    NA: "N/D",
    No: "No.",
    ...
    Diagnotisc: "Diagnosi",
    Solution: "Soluzione",
    ChargeCategory: "Categoria tariffa",
    Template_1: "Modello 1",
    ...
    //Pagina testata OdL
    ContactFName: "Prenome",
    ContactLName: "Cognome",
    ContactPhone: "Tel.",
    ContactEmail: "E-Mail",

    //Lista dei compiti
    taskList: "Lista dei compiti",
    taskOpen: "Compiti aperti",
    taskClose: "Compito chiudi",
    taskStarted: "Esegui al",
    taskHeader: "Argomento",
    taskType: "Tipo",
    ...
    taskWO: "OdL",
    taskBody: "Contenta",
    taskSeries: "Serie di compiti",
    taskStarted2: "Iniziato",
    markDone: "Marca completata",
    markSeriesDone: "Marca seriale completata",
    green: "Verde",
    red: "Rosso",
    orange: "Arancione",
    clear: "Cancella",
...
var translationsHU = {
    ...
    VIN: "Alvázszám",
    Model: "Modell",
    StampingCode: "Blokkolás-kód",
    NA: "N/A",
    No: "Nem.",
    CodeName: "Kód - Név",
    Code: "Kód",
    Job_No: "Munka száma",
    EstimatedTime: "Becsült idõ",
    Complaint: "Panasz",
    Diagnotisc: "Probléma",
    Solution: "Megoldás",
    ChargeCategory: "Költségkategória",
    Template_1: "Sablon 1",
    Template_2: "Sablon 2",
    Reset: "Visszaállítás",
    ...
    //workorder header-page
    ContactFName: "Keresztnév",
    ContactLName: "Vezetéknév",
    ContactPhone: "Telefon",
    ContactEmail: "Email",

    //TaskList
    taskList: "Feladatlista",
    taskOpen: "Nyitott feladatok",
    taskClose: "Végrehajtott feladatok",
    taskStarted: "Esedékes",
    taskHeader: "Tárgy",
    taskType: "Típus",
    taskCustomer: "Vevõ",
    taskPhone: "Telefon",
    ...
    taskWO: "Munkalap",
    taskBody: "Tartalom",
    taskSeries: "Feladat-sorozat",
    taskStarted2: "Elkezdve",
    markDone: "Elvégzettként jelöl",
    markSeriesDone: "Sorozat megjelölése elvégzettként",
    green: "Zöld",
    red: "Piros",
    orange: "Narancs",
    clear: "Töröl",
