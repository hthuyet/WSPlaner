UserWebApp.controller('OffersCtrl', function ($scope, $rootScope, $locale, HttpService, $translate, $location, $state, $filter, $uibModal, CommonServices) {
  $scope.lstAllData = [];
  $scope.lstData = [];
  $scope.lstSearch = [];
  ...
  $ctrl.open = function (size, item) {
    ...
    var modalInstance = $uibModal.open({
      ...
      templateUrl: '/wsplanning/templates/pages/offer/modal-form.html',
...
UserWebApp.controller('OfferModalCtrl', function ($scope, $rootScope, HttpService, $translate, $location, $filter, $uibModal, $uibModalInstance, item) {
