UserWebApp.controller('WorkBOCtrl', function ($scope, $rootScope, $locale, HttpService, $translate, $location, $state, $filter, $uibModal, CommonServices) {
  $scope.lstAllData = [];
  $scope.lstData = [];
  $scope.lstSearch = [];
  ...
  $ctrl.open = function (size, item) {
    ...
    var modalInstance = $uibModal.open({
      ...
      templateUrl: '/wsplanning/templates/pages/workBO/modal-form.html',
      controller: 'WorkBOModalCtrl',
      controllerAs: '$ctrl',
      size: size,
      resolve: {
        item: function () {
  ...
  $scope.viewDetail = function (item) {
    $state.go('app.main.workdetail', { 'id': item.WorkOrderId, 'type': "withBO" });
  }
...
UserWebApp.controller('WorkBOModalCtrl', function ($scope, $rootScope, HttpService, $translate, $location, $filter, $uibModal, $uibModalInstance, item) {
