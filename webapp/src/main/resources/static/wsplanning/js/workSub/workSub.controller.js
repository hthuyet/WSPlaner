UserWebApp.controller('WorkSubcontractorCtrl', function ($scope, $rootScope, $locale, HttpService, $translate, $location, $state, $filter, $uibModal, CommonServices) {
  $scope.lstAllData = [];
  $scope.lstData = [];
  $scope.lstSearch = [];
  ...
  $ctrl.open = function (size, item) {
    ...
    var modalInstance = $uibModal.open({
      ...
      templateUrl: '/wsplanning/templates/pages/workSub/modal-form.html',
      controller: 'WorkSubcontractorModalCtrl',
      controllerAs: '$ctrl',
      size: size,
      resolve: {
        item: function () {
  ...
  $scope.viewDetail = function (item) {
    $state.go('app.main.workdetail', { 'id': item.WorkOrderId, 'type': "withSubcontractor" });
  }
...
UserWebApp.controller('WorkSubcontractorModalCtrl', function ($scope, $rootScope, HttpService, $translate, $location, $filter, $uibModal, $uibModalInstance, item) {
