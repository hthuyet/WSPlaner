UserWebApp.controller('WorkTireCtrl', function ($scope, $rootScope, $locale, HttpService, $translate, $location, $state, $filter, $uibModal, CommonServices) {
  $scope.lstAllData = [];
  $scope.lstData = [];
  $scope.lstSearch = [];
  ...
  $ctrl.open = function (size, item) {
    ...
    var modalInstance = $uibModal.open({
      ...
      templateUrl: '/wsplanning/templates/pages/workTire/modal-form.html',
      controller: 'WoreTireModalCtrl',
      controllerAs: '$ctrl',
      size: size,
      resolve: {
        item: function () {
...
UserWebApp.controller('WoreTireModalCtrl', function ($scope, $rootScope, HttpService, $translate, $location, $filter, $uibModal, $uibModalInstance, item) {
