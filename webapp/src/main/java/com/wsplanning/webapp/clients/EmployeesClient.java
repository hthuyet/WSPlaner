...
//        return this.restTemplate.getForObject(url, String.class, maps);
    ...
    public String getPhoneCallEmployee(String db, String siteId) {
        String url = String.format("%s?command=getPhoneCallEmployee&SiteId=%s&Db=%s", this.endpointUrl, siteId, db);
        return restTemplate.getForObject(url, String.class);
    }
